module.exports = class Init1659665060460 {
  name = 'Init1659665060460'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "erc1155_contract" ("id" character varying NOT NULL, "name" text, "symbol" text, "total_supply" numeric NOT NULL, "contract_uri" text, "contract_uri_updated" numeric, "address" text, "decimals" integer, CONSTRAINT "PK_714a9ea4826d73898b5c2251116" PRIMARY KEY ("id"))`)
